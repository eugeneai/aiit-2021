...
\author{%
\IEEEauthorblockN{Duc The Tran${}^{1}$, Evgeny Cherkashin${}^{2,3}$}
...
In Table 1 and 2 we present the result of interest assessment to career guidance and relevance of improving of the guidance system.

\begin{table}
  \caption{Interest assessment to the carer guidance in Viet Nam}
  \label{tab:interest}
  \centering
  \begin{tabular}{|l|c|c|}
    \hline
