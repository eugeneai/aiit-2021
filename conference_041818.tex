...
{\color{red}Our research is aimed at application of known techniques to the cases of real estate market of Irkutsk region and, similarly, the market of education service of the region, as well as implement libraries for constructing RS using nowadays technologies.}
...
{\color{blue}The recommendation subsystem is currently implemented in real estate RS, using Slope One based collaborative filtration. } We assume that buyer purchases a flat not frequently and then each buyer is a new user, and no data about his/her preferences are available.
